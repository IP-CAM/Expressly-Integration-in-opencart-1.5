...
var servletUrl = "https://buyexpressly.com/expresslymod";
...
function checkSelfStoreUserEndpount() {
	...
	}, function () {}, "Basic " + modulePass, postData);
}
...
function checkServletEndpoints() {
	...
	createCall("GET", servletUrl + "/newmigration?data", function (data) {
 ...
 */
function updateRedirectToCheckout(selfElement, token) {
	createCall("GET", baseUrl + "index.php?route=module/expresslymigrator/updateRedirectToCheckout&redirect-to-checkout=" + selfElement.checked, function (data) {
	}, function () {}, "Basic " + modulePass);
}
